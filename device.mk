...
ifeq ($(strip $(MTK_RC_TO_VENDOR)), yes)
  ...
  ifeq ($(strip $(MTK_EMMC_SUPPORT)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt8163/ueventd.mt8163.emmc.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
  else ifeq ($(strip $(MTK_UFS_SUPPORT)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt8163/ueventd.mt8163.ufs.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
  endif
else
  MTK_TARGET_VENDOR_RC = root
  PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.vendor.rc=/
  ifeq ($(strip $(MTK_EMMC_SUPPORT)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt8163/ueventd.mt8163.emmc.rc:root/ueventd.mt8163.rc
  else ifeq ($(strip $(MTK_UFS_SUPPORT)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt8163/ueventd.mt8163.ufs.rc:root/ueventd.mt8163.rc
  endif
endif
...
PRODUCT_PACKAGES += consumerir.mt8163
else
# IRTX over PWM
...
# Vendor Modules
PRODUCT_PACKAGES += ilitek.ko
PRODUCT_PACKAGES += wlan_drv_gen2.ko
PRODUCT_PACKAGES += sitronix-ts.ko
PRODUCT_PACKAGES += hxchipset-i2c.ko
PRODUCT_PACKAGES += focaltech.ko
PRODUCT_PACKAGES += wmt_drv.ko
PRODUCT_PACKAGES += synaptics_dsx.ko
PRODUCT_PACKAGES += jadard_touch.ko
PRODUCT_PACKAGES += gsl37xx.ko
PRODUCT_PACKAGES += tda7708LX.ko
PRODUCT_PACKAGES += betterlife_ts.ko
PRODUCT_PACKAGES += qn8035.ko
PRODUCT_PACKAGES += si475x.ko
PRODUCT_PACKAGES += atmel_mxt_ts.ko
PRODUCT_PACKAGES += ak7604.ko
PRODUCT_PACKAGES += fy7604.ko
PRODUCT_PACKAGES += hyn_cst3xx.ko
PRODUCT_PACKAGES += fmradio_drv.ko
PRODUCT_PACKAGES += tp9951.ko
PRODUCT_PACKAGES += tp9950.ko
PRODUCT_PACKAGES += carstatus.ko
PRODUCT_PACKAGES += tp2825.ko
PRODUCT_PACKAGES += cd3313.ko
PRODUCT_PACKAGES += f_iap_zj.ko
PRODUCT_PACKAGES += f_iap_lt.ko
PRODUCT_PACKAGES += qn8027.ko
...
PRODUCT_PACKAGES += sound_trigger.primary.mt8163
...
PRODUCT_PACKAGES += thermal.mt8163
...
PRODUCT_PACKAGES += fstab.mt8163.ramdisk
...
PRODUCT_COPY_FILES += device/mediatek/mt8163/init.mt8163.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.mt8163.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/init.recovery.mt8163.rc:recovery/root/init.recovery.mt8163.rc
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt8163.nand:root/fstab.mt8163
endif
endif
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    ...
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.wfd.8163.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_00:mtk
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.pip.8163.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_01:mtk
    #PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.fdvrgis.8163.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_02:mtk
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.meta.8163.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_meta.conf:mtk
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.SW4KVP.8163.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_05:mtk
    #PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.SW4KVR.8163.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_06:mtk
...
ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_audio_tablet.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_audio_phone.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_audio_basic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
endif

ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
    PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_video_svp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
    PRODUCT_COPY_FILES += device/mediatek/mt8163/mtk_omx_core_svp.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
else
...
PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_c2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt8163/media_profiles_ducam.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
else
    ifeq ($(strip $(MTK_GMO_ROM_OPTIMIZE)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt8163/media_profiles_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt8163/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
    endif
endif

ifeq ($(MTK_CLEARMOTION_SUPPORT),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8163/mtk_clear_motion.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_clear_motion.cfg:mtk
endif
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt8163/audio_device_param/DSM_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/DSM_config.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8163/audio_device_param/DSM.xml:$(TARGET_COPY_OUT_VENDOR)/etc/DSM.xml:mtk

ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    MTK_AUDIO_PARAM_DIR_LIST += device/mediatek/mt8163/audio_param
...
PRODUCT_PACKAGES   += 	kmsetkey.mt8163
endif
...
PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mediatek.platform=MT8163
